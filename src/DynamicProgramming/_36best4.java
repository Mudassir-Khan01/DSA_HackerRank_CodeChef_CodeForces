...
public class _36best4 {
    ...
    //tabul
    public static int maximumProfit2(int[] prices, int n, int k) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The maximum profit that can be generated is " + maximumProfit2(prices, n, k));
